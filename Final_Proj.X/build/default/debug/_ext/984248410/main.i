# 1 "../../Desktop/2025_MICROCHIP_FINAL_PROJECT_2.0-main/2025_MICROCHIP_FINAL_PROJECT_2.0-main/main.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 285 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "../../Desktop/2025_MICROCHIP_FINAL_PROJECT_2.0-main/2025_MICROCHIP_FINAL_PROJECT_2.0-main/main.c" 2
...
# 2 "../../Desktop/2025_MICROCHIP_FINAL_PROJECT_2.0-main/2025_MICROCHIP_FINAL_PROJECT_2.0-main/main.c" 2
...
# 3 "../../Desktop/2025_MICROCHIP_FINAL_PROJECT_2.0-main/2025_MICROCHIP_FINAL_PROJECT_2.0-main/main.c" 2
...
void ClearBuffer();
void MyusartRead();
# 4 "../../Desktop/2025_MICROCHIP_FINAL_PROJECT_2.0-main/2025_MICROCHIP_FINAL_PROJECT_2.0-main/main.c" 2
...
void PROCESS_ONE(void){
    TTTO_TABLE = TTT_START(TTTO_TABLE);
    while(TTTO_TABLE.DETWINNER == 0){
        if(!ADCON0bits.GO){
            ADCON0bits.GO = 1;
        }
        TTT_OUTPUT(TTTO_TABLE);
    }
...
void PROCESS_THREE(void){
    ...
    REACTO_TABLE = REACTION_START(REACTO_TABLE);
    T2CONbits.TMR2ON = 1;
    while(REACTO_TABLE.PLAYER1_STATE != 2 || REACTO_TABLE.PLAYER2_STATE !=2){
        ...
        REACTO_TABLE = REACTION_UPDATE(REACTO_TABLE);
...
void main(void){
    ...
    GameSwiching(1+!TTTO_TABLE.CURPLAYER);
...
void __attribute__((picinterrupt(("high_priority")))) Hi_ISR(void)
{
    ...
    if(INTCONbits.INT0IF == 1){
        ...
        if(GC_TABLE.PROCESS == 1){
            delay(60000);
            TTTO_TABLE = TTT_UPDATE(TTTO_TABLE,1,0,TTTO_TABLE.CURSOR);
            INTCONbits.INT0IF = 0;
            return;
        }
